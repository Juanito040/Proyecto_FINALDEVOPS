...
import { Calendar, Laptop, Activity, Clock, Search, Plus, LogOut, Check, User, History } from 'lucide-react';
      ...
      <div className="app-content">
        <header className="app-header">
          <h1 className="app-title">
            <Calendar className="title-icon" size={36} />
        ...
        <div className="tabs-container">
          <button onClick={() => setActiveTab('computers')} className={`tab ${activeTab === 'computers' ? 'tab-active tab-blue' : ''}`}>
            <Laptop className="tab-icon" size={18} />
            Computadoras
          </button>
          <button onClick={() => setActiveTab('medical')} className={`tab ${activeTab === 'medical' ? 'tab-active tab-green' : ''}`}>
            <Activity className="tab-icon" size={18} />
            Dispositivos Médicos
          </button>
          <button onClick={() => setActiveTab('frequent')} className={`tab ${activeTab === 'frequent' ? 'tab-active tab-purple' : ''}`}>
            <Clock className="tab-icon" size={18} />
            Frecuentes
          </button>
          <button onClick={() => setActiveTab('entered')} className={`tab ${activeTab === 'entered' ? 'tab-active tab-orange' : ''}`}>
            <Search className="tab-icon" size={18} />
