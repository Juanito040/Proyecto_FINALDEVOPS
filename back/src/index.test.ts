...
import { SqlDeviceRepository } from "./adapter/repository/sql/sql.device-repository";
...
describe("Elysia Device API with Azure & SQLite", () => {
  let app: Elysia
  let deviceRepository: SqlDeviceRepository
  ...
  beforeAll(async () => {
    ...
    deviceRepository = new SqlDeviceRepository(TEST_DB_PATH)
